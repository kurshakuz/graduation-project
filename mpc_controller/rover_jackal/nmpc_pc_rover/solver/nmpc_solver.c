...
{
nmpcWorkspace.H[(iRow * 132 + 396) + (iCol * 2 + 6)] += + Gu1[0]*Gu2[0] + Gu1[2]*Gu2[2] + Gu1[4]*Gu2[4] + Gu1[6]*Gu2[6] + Gu1[8]*Gu2[8] + Gu1[10]*Gu2[10];
nmpcWorkspace.H[(iRow * 132 + 396) + (iCol * 2 + 7)] += + Gu1[0]*Gu2[1] + Gu1[2]*Gu2[3] + Gu1[4]*Gu2[5] + Gu1[6]*Gu2[7] + Gu1[8]*Gu2[9] + Gu1[10]*Gu2[11];
nmpcWorkspace.H[(iRow * 132 + 462) + (iCol * 2 + 6)] += + Gu1[1]*Gu2[0] + Gu1[3]*Gu2[2] + Gu1[5]*Gu2[4] + Gu1[7]*Gu2[6] + Gu1[9]*Gu2[8] + Gu1[11]*Gu2[10];
nmpcWorkspace.H[(iRow * 132 + 462) + (iCol * 2 + 7)] += + Gu1[1]*Gu2[1] + Gu1[3]*Gu2[3] + Gu1[5]*Gu2[5] + Gu1[7]*Gu2[7] + Gu1[9]*Gu2[9] + Gu1[11]*Gu2[11];
}

void nmpc_setBlockH11_R1( int iRow, int iCol, real_t* const R11 )
{
nmpcWorkspace.H[(iRow * 132 + 396) + (iCol * 2 + 6)] = R11[0];
nmpcWorkspace.H[(iRow * 132 + 396) + (iCol * 2 + 7)] = R11[1];
nmpcWorkspace.H[(iRow * 132 + 462) + (iCol * 2 + 6)] = R11[2];
nmpcWorkspace.H[(iRow * 132 + 462) + (iCol * 2 + 7)] = R11[3];
}

void nmpc_zeroBlockH11( int iRow, int iCol )
{
nmpcWorkspace.H[(iRow * 132 + 396) + (iCol * 2 + 6)] = 0.0000000000000000e+00;
nmpcWorkspace.H[(iRow * 132 + 396) + (iCol * 2 + 7)] = 0.0000000000000000e+00;
nmpcWorkspace.H[(iRow * 132 + 462) + (iCol * 2 + 6)] = 0.0000000000000000e+00;
nmpcWorkspace.H[(iRow * 132 + 462) + (iCol * 2 + 7)] = 0.0000000000000000e+00;
}

void nmpc_copyHTH( int iRow, int iCol )
{
nmpcWorkspace.H[(iRow * 132 + 396) + (iCol * 2 + 6)] = nmpcWorkspace.H[(iCol * 132 + 396) + (iRow * 2 + 6)];
nmpcWorkspace.H[(iRow * 132 + 396) + (iCol * 2 + 7)] = nmpcWorkspace.H[(iCol * 132 + 462) + (iRow * 2 + 6)];
nmpcWorkspace.H[(iRow * 132 + 462) + (iCol * 2 + 6)] = nmpcWorkspace.H[(iCol * 132 + 396) + (iRow * 2 + 7)];
nmpcWorkspace.H[(iRow * 132 + 462) + (iCol * 2 + 7)] = nmpcWorkspace.H[(iCol * 132 + 462) + (iRow * 2 + 7)];
}
...
nmpcWorkspace.H[70] = 0.0000000000000000e+00;
nmpcWorkspace.H[71] = 0.0000000000000000e+00;
...
nmpcWorkspace.H[200] = 0.0000000000000000e+00;
nmpcWorkspace.H[201] = 0.0000000000000000e+00;
nmpcWorkspace.H[202] = 0.0000000000000000e+00;
nmpcWorkspace.H[203] = 0.0000000000000000e+00;
...
nmpcWorkspace.H[66] += + Gx1[1]*Gx2[0] + Gx1[7]*Gx2[6] + Gx1[13]*Gx2[12] + Gx1[19]*Gx2[18] + Gx1[25]*Gx2[24] + Gx1[31]*Gx2[30];
nmpcWorkspace.H[67] += + Gx1[1]*Gx2[1] + Gx1[7]*Gx2[7] + Gx1[13]*Gx2[13] + Gx1[19]*Gx2[19] + Gx1[25]*Gx2[25] + Gx1[31]*Gx2[31];
nmpcWorkspace.H[68] += + Gx1[1]*Gx2[2] + Gx1[7]*Gx2[8] + Gx1[13]*Gx2[14] + Gx1[19]*Gx2[20] + Gx1[25]*Gx2[26] + Gx1[31]*Gx2[32];
nmpcWorkspace.H[69] += + Gx1[1]*Gx2[3] + Gx1[7]*Gx2[9] + Gx1[13]*Gx2[15] + Gx1[19]*Gx2[21] + Gx1[25]*Gx2[27] + Gx1[31]*Gx2[33];
nmpcWorkspace.H[70] += + Gx1[1]*Gx2[4] + Gx1[7]*Gx2[10] + Gx1[13]*Gx2[16] + Gx1[19]*Gx2[22] + Gx1[25]*Gx2[28] + Gx1[31]*Gx2[34];
nmpcWorkspace.H[71] += + Gx1[1]*Gx2[5] + Gx1[7]*Gx2[11] + Gx1[13]*Gx2[17] + Gx1[19]*Gx2[23] + Gx1[25]*Gx2[29] + Gx1[31]*Gx2[35];
nmpcWorkspace.H[132] += + Gx1[2]*Gx2[0] + Gx1[8]*Gx2[6] + Gx1[14]*Gx2[12] + Gx1[20]*Gx2[18] + Gx1[26]*Gx2[24] + Gx1[32]*Gx2[30];
nmpcWorkspace.H[133] += + Gx1[2]*Gx2[1] + Gx1[8]*Gx2[7] + Gx1[14]*Gx2[13] + Gx1[20]*Gx2[19] + Gx1[26]*Gx2[25] + Gx1[32]*Gx2[31];
nmpcWorkspace.H[134] += + Gx1[2]*Gx2[2] + Gx1[8]*Gx2[8] + Gx1[14]*Gx2[14] + Gx1[20]*Gx2[20] + Gx1[26]*Gx2[26] + Gx1[32]*Gx2[32];
nmpcWorkspace.H[135] += + Gx1[2]*Gx2[3] + Gx1[8]*Gx2[9] + Gx1[14]*Gx2[15] + Gx1[20]*Gx2[21] + Gx1[26]*Gx2[27] + Gx1[32]*Gx2[33];
nmpcWorkspace.H[136] += + Gx1[2]*Gx2[4] + Gx1[8]*Gx2[10] + Gx1[14]*Gx2[16] + Gx1[20]*Gx2[22] + Gx1[26]*Gx2[28] + Gx1[32]*Gx2[34];
nmpcWorkspace.H[137] += + Gx1[2]*Gx2[5] + Gx1[8]*Gx2[11] + Gx1[14]*Gx2[17] + Gx1[20]*Gx2[23] + Gx1[26]*Gx2[29] + Gx1[32]*Gx2[35];
nmpcWorkspace.H[198] += + Gx1[3]*Gx2[0] + Gx1[9]*Gx2[6] + Gx1[15]*Gx2[12] + Gx1[21]*Gx2[18] + Gx1[27]*Gx2[24] + Gx1[33]*Gx2[30];
nmpcWorkspace.H[199] += + Gx1[3]*Gx2[1] + Gx1[9]*Gx2[7] + Gx1[15]*Gx2[13] + Gx1[21]*Gx2[19] + Gx1[27]*Gx2[25] + Gx1[33]*Gx2[31];
nmpcWorkspace.H[200] += + Gx1[3]*Gx2[2] + Gx1[9]*Gx2[8] + Gx1[15]*Gx2[14] + Gx1[21]*Gx2[20] + Gx1[27]*Gx2[26] + Gx1[33]*Gx2[32];
nmpcWorkspace.H[201] += + Gx1[3]*Gx2[3] + Gx1[9]*Gx2[9] + Gx1[15]*Gx2[15] + Gx1[21]*Gx2[21] + Gx1[27]*Gx2[27] + Gx1[33]*Gx2[33];
nmpcWorkspace.H[202] += + Gx1[3]*Gx2[4] + Gx1[9]*Gx2[10] + Gx1[15]*Gx2[16] + Gx1[21]*Gx2[22] + Gx1[27]*Gx2[28] + Gx1[33]*Gx2[34];
nmpcWorkspace.H[203] += + Gx1[3]*Gx2[5] + Gx1[9]*Gx2[11] + Gx1[15]*Gx2[17] + Gx1[21]*Gx2[23] + Gx1[27]*Gx2[29] + Gx1[33]*Gx2[35];
nmpcWorkspace.H[264] += + Gx1[4]*Gx2[0] + Gx1[10]*Gx2[6] + Gx1[16]*Gx2[12] + Gx1[22]*Gx2[18] + Gx1[28]*Gx2[24] + Gx1[34]*Gx2[30];
nmpcWorkspace.H[265] += + Gx1[4]*Gx2[1] + Gx1[10]*Gx2[7] + Gx1[16]*Gx2[13] + Gx1[22]*Gx2[19] + Gx1[28]*Gx2[25] + Gx1[34]*Gx2[31];
nmpcWorkspace.H[266] += + Gx1[4]*Gx2[2] + Gx1[10]*Gx2[8] + Gx1[16]*Gx2[14] + Gx1[22]*Gx2[20] + Gx1[28]*Gx2[26] + Gx1[34]*Gx2[32];
nmpcWorkspace.H[267] += + Gx1[4]*Gx2[3] + Gx1[10]*Gx2[9] + Gx1[16]*Gx2[15] + Gx1[22]*Gx2[21] + Gx1[28]*Gx2[27] + Gx1[34]*Gx2[33];
nmpcWorkspace.H[268] += + Gx1[4]*Gx2[4] + Gx1[10]*Gx2[10] + Gx1[16]*Gx2[16] + Gx1[22]*Gx2[22] + Gx1[28]*Gx2[28] + Gx1[34]*Gx2[34];
nmpcWorkspace.H[269] += + Gx1[4]*Gx2[5] + Gx1[10]*Gx2[11] + Gx1[16]*Gx2[17] + Gx1[22]*Gx2[23] + Gx1[28]*Gx2[29] + Gx1[34]*Gx2[35];
nmpcWorkspace.H[330] += + Gx1[5]*Gx2[0] + Gx1[11]*Gx2[6] + Gx1[17]*Gx2[12] + Gx1[23]*Gx2[18] + Gx1[29]*Gx2[24] + Gx1[35]*Gx2[30];
nmpcWorkspace.H[331] += + Gx1[5]*Gx2[1] + Gx1[11]*Gx2[7] + Gx1[17]*Gx2[13] + Gx1[23]*Gx2[19] + Gx1[29]*Gx2[25] + Gx1[35]*Gx2[31];
nmpcWorkspace.H[332] += + Gx1[5]*Gx2[2] + Gx1[11]*Gx2[8] + Gx1[17]*Gx2[14] + Gx1[23]*Gx2[20] + Gx1[29]*Gx2[26] + Gx1[35]*Gx2[32];
nmpcWorkspace.H[333] += + Gx1[5]*Gx2[3] + Gx1[11]*Gx2[9] + Gx1[17]*Gx2[15] + Gx1[23]*Gx2[21] + Gx1[29]*Gx2[27] + Gx1[35]*Gx2[33];
nmpcWorkspace.H[334] += + Gx1[5]*Gx2[4] + Gx1[11]*Gx2[10] + Gx1[17]*Gx2[16] + Gx1[23]*Gx2[22] + Gx1[29]*Gx2[28] + Gx1[35]*Gx2[34];
nmpcWorkspace.H[335] += + Gx1[5]*Gx2[5] + Gx1[11]*Gx2[11] + Gx1[17]*Gx2[17] + Gx1[23]*Gx2[23] + Gx1[29]*Gx2[29] + Gx1[35]*Gx2[35];
}
...
nmpc_multGxGu( nmpcWorkspace.T, &(nmpcWorkspace.E[ lRun4 * 12 ]), &(nmpcWorkspace.E[ lRun3 * 12 ]) );
}
lRun3 = (((lRun1 + 1) * (lRun1)) / (2)) + (lRun2);
nmpc_moveGuE( &(nmpcWorkspace.evGu[ lRun1 * 12 ]), &(nmpcWorkspace.E[ lRun3 * 12 ]) );
}
...
{
lRun3 = (((lRun1 + 1) * (lRun1)) / (2)) + (lRun2);
nmpc_multGxGu( &(nmpcWorkspace.Q1[ lRun1 * 36 + 36 ]), &(nmpcWorkspace.E[ lRun3 * 12 ]), &(nmpcWorkspace.QE[ lRun3 * 12 ]) );
}
}
...
{
lRun3 = (((lRun1 + 1) * (lRun1)) / (2)) + (lRun2);
nmpc_multGxGu( nmpcWorkspace.QN1, &(nmpcWorkspace.E[ lRun3 * 12 ]), &(nmpcWorkspace.QE[ lRun3 * 12 ]) );
}
...
for (lRun1 = 0; lRun1 < 30; ++lRun1)
{
nmpc_zeroBlockH10( &(nmpcWorkspace.H10[ lRun1 * 12 ]) );
for (lRun2 = lRun1; lRun2 < 30; ++lRun2)
{
lRun3 = (((lRun2 + 1) * (lRun2)) / (2)) + (lRun1);
nmpc_multQETGx( &(nmpcWorkspace.QE[ lRun3 * 12 ]), &(nmpcWorkspace.evGx[ lRun2 * 36 ]), &(nmpcWorkspace.H10[ lRun1 * 12 ]) );
}
}

for (lRun1 = 0;lRun1 < 6; ++lRun1)
for (lRun2 = 0;lRun2 < 60; ++lRun2)
nmpcWorkspace.H[(lRun1 * 66) + (lRun2 + 6)] = nmpcWorkspace.H10[(lRun2 * 6) + (lRun1)];
...
nmpc_setBlockH11( lRun1, lRun2, &(nmpcWorkspace.E[ lRun4 * 12 ]), &(nmpcWorkspace.QE[ lRun5 * 12 ]) );
}
...
nmpcWorkspace.H[(lRun1 * 66 + 396) + (lRun2)] = nmpcWorkspace.H10[(lRun1 * 6) + (lRun2)];
...
{
lRun3 = (((lRun2 + 1) * (lRun2)) / (2)) + (lRun1);
nmpc_macETSlu( &(nmpcWorkspace.QE[ lRun3 * 12 ]), &(nmpcWorkspace.g[ lRun1 * 2 + 6 ]) );
}
}
nmpcWorkspace.lb[6] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[0];
nmpcWorkspace.lb[7] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[1];
nmpcWorkspace.lb[8] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[2];
nmpcWorkspace.lb[9] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[3];
nmpcWorkspace.lb[10] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[4];
nmpcWorkspace.lb[11] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[5];
nmpcWorkspace.lb[12] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[6];
nmpcWorkspace.lb[13] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[7];
nmpcWorkspace.lb[14] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[8];
nmpcWorkspace.lb[15] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[9];
nmpcWorkspace.lb[16] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[10];
nmpcWorkspace.lb[17] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[11];
nmpcWorkspace.lb[18] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[12];
nmpcWorkspace.lb[19] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[13];
nmpcWorkspace.lb[20] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[14];
nmpcWorkspace.lb[21] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[15];
nmpcWorkspace.lb[22] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[16];
nmpcWorkspace.lb[23] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[17];
nmpcWorkspace.lb[24] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[18];
nmpcWorkspace.lb[25] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[19];
nmpcWorkspace.lb[26] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[20];
nmpcWorkspace.lb[27] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[21];
nmpcWorkspace.lb[28] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[22];
nmpcWorkspace.lb[29] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[23];
nmpcWorkspace.lb[30] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[24];
nmpcWorkspace.lb[31] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[25];
nmpcWorkspace.lb[32] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[26];
nmpcWorkspace.lb[33] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[27];
nmpcWorkspace.lb[34] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[28];
nmpcWorkspace.lb[35] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[29];
nmpcWorkspace.lb[36] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[30];
nmpcWorkspace.lb[37] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[31];
nmpcWorkspace.lb[38] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[32];
nmpcWorkspace.lb[39] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[33];
nmpcWorkspace.lb[40] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[34];
nmpcWorkspace.lb[41] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[35];
nmpcWorkspace.lb[42] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[36];
nmpcWorkspace.lb[43] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[37];
nmpcWorkspace.lb[44] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[38];
nmpcWorkspace.lb[45] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[39];
nmpcWorkspace.lb[46] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[40];
nmpcWorkspace.lb[47] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[41];
nmpcWorkspace.lb[48] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[42];
nmpcWorkspace.lb[49] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[43];
nmpcWorkspace.lb[50] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[44];
nmpcWorkspace.lb[51] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[45];
nmpcWorkspace.lb[52] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[46];
nmpcWorkspace.lb[53] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[47];
nmpcWorkspace.lb[54] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[48];
nmpcWorkspace.lb[55] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[49];
nmpcWorkspace.lb[56] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[50];
nmpcWorkspace.lb[57] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[51];
nmpcWorkspace.lb[58] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[52];
nmpcWorkspace.lb[59] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[53];
nmpcWorkspace.lb[60] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[54];
nmpcWorkspace.lb[61] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[55];
nmpcWorkspace.lb[62] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[56];
nmpcWorkspace.lb[63] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[57];
nmpcWorkspace.lb[64] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[58];
nmpcWorkspace.lb[65] = (real_t)-1.0000000000000000e+12 - nmpcVariables.u[59];
nmpcWorkspace.ub[6] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[0];
nmpcWorkspace.ub[7] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[1];
nmpcWorkspace.ub[8] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[2];
nmpcWorkspace.ub[9] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[3];
nmpcWorkspace.ub[10] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[4];
nmpcWorkspace.ub[11] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[5];
nmpcWorkspace.ub[12] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[6];
nmpcWorkspace.ub[13] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[7];
nmpcWorkspace.ub[14] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[8];
nmpcWorkspace.ub[15] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[9];
nmpcWorkspace.ub[16] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[10];
nmpcWorkspace.ub[17] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[11];
nmpcWorkspace.ub[18] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[12];
nmpcWorkspace.ub[19] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[13];
nmpcWorkspace.ub[20] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[14];
nmpcWorkspace.ub[21] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[15];
nmpcWorkspace.ub[22] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[16];
nmpcWorkspace.ub[23] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[17];
nmpcWorkspace.ub[24] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[18];
nmpcWorkspace.ub[25] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[19];
nmpcWorkspace.ub[26] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[20];
nmpcWorkspace.ub[27] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[21];
nmpcWorkspace.ub[28] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[22];
nmpcWorkspace.ub[29] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[23];
nmpcWorkspace.ub[30] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[24];
nmpcWorkspace.ub[31] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[25];
nmpcWorkspace.ub[32] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[26];
nmpcWorkspace.ub[33] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[27];
nmpcWorkspace.ub[34] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[28];
nmpcWorkspace.ub[35] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[29];
nmpcWorkspace.ub[36] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[30];
nmpcWorkspace.ub[37] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[31];
nmpcWorkspace.ub[38] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[32];
nmpcWorkspace.ub[39] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[33];
nmpcWorkspace.ub[40] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[34];
nmpcWorkspace.ub[41] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[35];
nmpcWorkspace.ub[42] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[36];
nmpcWorkspace.ub[43] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[37];
nmpcWorkspace.ub[44] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[38];
nmpcWorkspace.ub[45] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[39];
nmpcWorkspace.ub[46] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[40];
nmpcWorkspace.ub[47] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[41];
nmpcWorkspace.ub[48] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[42];
nmpcWorkspace.ub[49] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[43];
nmpcWorkspace.ub[50] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[44];
nmpcWorkspace.ub[51] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[45];
nmpcWorkspace.ub[52] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[46];
nmpcWorkspace.ub[53] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[47];
nmpcWorkspace.ub[54] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[48];
nmpcWorkspace.ub[55] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[49];
nmpcWorkspace.ub[56] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[50];
nmpcWorkspace.ub[57] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[51];
nmpcWorkspace.ub[58] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[52];
nmpcWorkspace.ub[59] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[53];
nmpcWorkspace.ub[60] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[54];
nmpcWorkspace.ub[61] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[55];
nmpcWorkspace.ub[62] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[56];
nmpcWorkspace.ub[63] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[57];
nmpcWorkspace.ub[64] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[58];
nmpcWorkspace.ub[65] = (real_t)1.0000000000000000e+12 - nmpcVariables.u[59];
...
nmpc_multRDy( &(nmpcWorkspace.R2[ 16 ]), &(nmpcWorkspace.Dy[ 8 ]), &(nmpcWorkspace.g[ 8 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 32 ]), &(nmpcWorkspace.Dy[ 16 ]), &(nmpcWorkspace.g[ 10 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 48 ]), &(nmpcWorkspace.Dy[ 24 ]), &(nmpcWorkspace.g[ 12 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 64 ]), &(nmpcWorkspace.Dy[ 32 ]), &(nmpcWorkspace.g[ 14 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 80 ]), &(nmpcWorkspace.Dy[ 40 ]), &(nmpcWorkspace.g[ 16 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 96 ]), &(nmpcWorkspace.Dy[ 48 ]), &(nmpcWorkspace.g[ 18 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 112 ]), &(nmpcWorkspace.Dy[ 56 ]), &(nmpcWorkspace.g[ 20 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 128 ]), &(nmpcWorkspace.Dy[ 64 ]), &(nmpcWorkspace.g[ 22 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 144 ]), &(nmpcWorkspace.Dy[ 72 ]), &(nmpcWorkspace.g[ 24 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 160 ]), &(nmpcWorkspace.Dy[ 80 ]), &(nmpcWorkspace.g[ 26 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 176 ]), &(nmpcWorkspace.Dy[ 88 ]), &(nmpcWorkspace.g[ 28 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 192 ]), &(nmpcWorkspace.Dy[ 96 ]), &(nmpcWorkspace.g[ 30 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 208 ]), &(nmpcWorkspace.Dy[ 104 ]), &(nmpcWorkspace.g[ 32 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 224 ]), &(nmpcWorkspace.Dy[ 112 ]), &(nmpcWorkspace.g[ 34 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 240 ]), &(nmpcWorkspace.Dy[ 120 ]), &(nmpcWorkspace.g[ 36 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 256 ]), &(nmpcWorkspace.Dy[ 128 ]), &(nmpcWorkspace.g[ 38 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 272 ]), &(nmpcWorkspace.Dy[ 136 ]), &(nmpcWorkspace.g[ 40 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 288 ]), &(nmpcWorkspace.Dy[ 144 ]), &(nmpcWorkspace.g[ 42 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 304 ]), &(nmpcWorkspace.Dy[ 152 ]), &(nmpcWorkspace.g[ 44 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 320 ]), &(nmpcWorkspace.Dy[ 160 ]), &(nmpcWorkspace.g[ 46 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 336 ]), &(nmpcWorkspace.Dy[ 168 ]), &(nmpcWorkspace.g[ 48 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 352 ]), &(nmpcWorkspace.Dy[ 176 ]), &(nmpcWorkspace.g[ 50 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 368 ]), &(nmpcWorkspace.Dy[ 184 ]), &(nmpcWorkspace.g[ 52 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 384 ]), &(nmpcWorkspace.Dy[ 192 ]), &(nmpcWorkspace.g[ 54 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 400 ]), &(nmpcWorkspace.Dy[ 200 ]), &(nmpcWorkspace.g[ 56 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 416 ]), &(nmpcWorkspace.Dy[ 208 ]), &(nmpcWorkspace.g[ 58 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 432 ]), &(nmpcWorkspace.Dy[ 216 ]), &(nmpcWorkspace.g[ 60 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 448 ]), &(nmpcWorkspace.Dy[ 224 ]), &(nmpcWorkspace.g[ 62 ]) );
nmpc_multRDy( &(nmpcWorkspace.R2[ 464 ]), &(nmpcWorkspace.Dy[ 232 ]), &(nmpcWorkspace.g[ 64 ]) );
...
{
lRun3 = (((lRun2 + 1) * (lRun2)) / (2)) + (lRun1);
nmpc_multEQDy( &(nmpcWorkspace.E[ lRun3 * 12 ]), &(nmpcWorkspace.QDy[ lRun2 * 6 + 6 ]), &(nmpcWorkspace.g[ lRun1 * 2 + 6 ]) );
}
}
...
{
lRun3 = (((lRun1 + 1) * (lRun1)) / (2)) + (lRun2);
nmpc_multEDu( &(nmpcWorkspace.E[ lRun3 * 12 ]), &(nmpcWorkspace.x[ lRun2 * 2 + 6 ]), &(nmpcVariables.x[ lRun1 * 6 + 6 ]) );
}
}
}
...
{
nmpcWorkspace.state[54] = nmpcVariables.u[58];
nmpcWorkspace.state[55] = nmpcVariables.u[59];
}
