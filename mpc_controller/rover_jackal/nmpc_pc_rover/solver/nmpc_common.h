...
#define NMPC_QP_NV 66
/** Number of integration steps per shooting interval. */
#define NMPC_RK_NIS 2
...
/** Matrix of size: 180 x 8 (row major format) */
real_t Q2[ 1440 ];

/** Matrix of size: 60 x 2 (row major format) */
real_t R1[ 120 ];

/** Matrix of size: 60 x 8 (row major format) */
real_t R2[ 480 ];
...
/** Matrix of size: 2790 x 2 (row major format) */
real_t E[ 5580 ];
...
/** Matrix of size: 66 x 66 (row major format) */
real_t H[ 4356 ];
