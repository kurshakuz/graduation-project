#ifndef _NMPC_PC_ROVER_H
#define _NMPC_PC_ROVER_H
...
class NMPC_PC
{
	...
	public:	
		...
		void nmpc_core(struct acado_struct &acadostruct, struct command_struct &commandstruct, std::vector<double> &reftrajectory, std::vector<double> &statesmeas);
	...
	protected:
		...
		void set_measurements(struct acado_struct &acadostruct,  std::vector<double> &statesmeas);
