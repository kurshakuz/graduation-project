...
ros::Publisher wheelLinVel_body_mocap_pub;
ros::Publisher wheelRotVel_pub;
...
int model_idx;
std::vector<int> wheelRotVel_idx;
std::vector<double> wheelRotVel_vec;
std::vector<double> wheelLinVel_vec;
